...
public class OkHttpClientManager {
    ...
    private static OkHttpClientManager sOkHttpClientManager = new OkHttpClientManager();
    ...
    public CookieFactory mCookieFactory;

    public static OkHttpClientManager getInstance() {
        return sOkHttpClientManager;
    }

    public void init(final Context context, CookieFactory factory) {
